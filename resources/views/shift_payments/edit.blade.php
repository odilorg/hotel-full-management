...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Edit new Payment') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">{{ __('Edit new Payment') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="/shift_payments/{{ $shiftPayment->id }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="exampleInputEmail1">{{ __('Payment Description') }}</label>
                                    <input type="text" value="{{ old('payment_description', $shiftPayment->payment_description) }}" name="payment_description" class="form-control  @error('payment_description')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('payment_amount_uzs', $shiftPayment->payment_amount_uzs) }}" name="payment_amount_uzs" class="form-control  @error('payment_amount_uzs')
