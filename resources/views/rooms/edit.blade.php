                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-body">
                            <form action="/rooms/{{ $room->id }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('room_name', $room->room_name) }}" name="room_name" class="form-control  @error('room_name')
                 {{ 'is-invalid' }} @enderror " id="inputError" placeholder="Room Name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('room_id', $room->room_id) }}" name="room_id" class="form-control @error('room_id')
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Beds24 Room Id">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('room_number', $room->room_number) }}" name="room_number" class="form-control @error('room_number')
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Room Number">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('unit_id', $room->unit_id) }}" name="unit_id" class="form-control @error('unit_id')
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Beds24 Unit Id">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('room_size', $room->room_size) }}" name="room_size" class="form-control @error('room_size')
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Room size">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('room_floor', $room->room_floor) }}" name="room_floor" class="form-control @error('room_floor')
