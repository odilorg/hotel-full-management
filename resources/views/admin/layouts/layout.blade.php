...
<head>
    ...
    <script src="{{ asset('assets/admin/js/numbers_format.js') }}"></script>
	...
	*/
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		...
		td:nth-of-type(2):before { content: "Company Official name"; }
		td:nth-of-type(3):before { content: "INN"; }
        td:nth-of-type(4):before { content: "Company Street"; }
        td:nth-of-type(5):before { content: "Company Phone"; }
        td:nth-of-type(6):before { content: "Company Email"; }
        td:nth-of-type(7):before { content: "Company Acc #"; }
        td:nth-of-type(8):before { content: "Company Bank"; }
        td:nth-of-type(9):before { content: "Bank MFO"; }
        td:nth-of-type(10):before { content: "Company Address City"; }
