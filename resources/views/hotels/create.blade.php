...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create new Hotel</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-6">
                 ...
                 {{ 'is-invalid' }} @enderror " id="inputError" placeholder="Hotel Name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('hotel_slug') }}" name="hotel_slug" class="form-control @error('hotel_slug')
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Hotel Slug">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('hotel_address') }}" name="hotel_address" class="form-control @error('hotel_address')
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Hotel Address">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('hotel_room_quantity') }}" name="hotel_room_quantity" class="form-control @error('hotel_room_quantity')
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Hotel room quantity">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Hotel Room Types</label>
                                    <input type="text" value="{{ old('hotel_room_types') }}" name="hotel_room_types" class="form-control @error('hotel_room_types')
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Hotel room types">
                                    @error('hotel_room_types')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Hotel Phone</label>
                                    <input type="text" value="{{ old('hotel_phone') }}" name="hotel_phone" class="form-control @error('hotel_phone')
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Hotel phone">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('hotel_email') }}" name="hotel_email" class="form-control @error('hotel_email')
