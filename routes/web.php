...
Route::post('/beds24bookings/beds24web_checkout', [Beds24bookingController::class, 'beds24web_checkout'])->name('beds24bookings.beds24web_checkout')->middleware(['auth', 'revalidate']);;
